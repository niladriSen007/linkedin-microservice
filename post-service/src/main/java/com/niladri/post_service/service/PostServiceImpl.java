...
import com.niladri.post_service.producers.PostCreationKafkaProducer;
...
public class PostServiceImpl implements IPostService {
    ...
    private final PostCreationKafkaProducer postCreationKafkaProducer;
    ...
    public PostResponseDto createPost(PostRequestDto postRequest) {
        ...
        postCreationKafkaProducer.publishPostCreationEvent("post-creation-topic", postCreationEvent);
