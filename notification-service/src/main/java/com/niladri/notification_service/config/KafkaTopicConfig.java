...
//    }
    ...
    public ProducerFactory<String, Object> producerFactory() {
        ...
        log.info("Kafka Producer Configured with bootstrap server in notification service: {}", bootstrapServer);
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        log.info("Kafka Consumer Configured with bootstrap server in notification service: {} and group id: {}", bootstrapServer, groupId);
